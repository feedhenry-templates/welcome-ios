...
// sample values commented below are for https://github.com/feedhenry-templates/welcome-ios
/* ------------- use these to hardcode values in Jenkinsfile ---------------- */
PROJECT_NAME = "welcome-ios"
INFO_PLIST = "welcome-ios/welcome-ios-Info.plist"
VERSION = "0.1-alpha"
SHORT_VERSION = "0.1"
BUNDLE_ID = "com.feedhenry.welcome-ios"
...
/*
PROJECT_NAME = params?.PROJECT_NAME?.trim()                         // e.g. "welcome-ios"
INFO_PLIST = params?.INFO_PLIST?.trim()                             // e.g. "welcome-ios/welcome-ios-Info.plist"
VERSION = params?.APP_VERSION?.trim()                               // e.g. "0.1-alpha"
SHORT_VERSION = params?.APP_SHORT_VERSION?.trim()                   // e.g. "0.1"
BUNDLE_ID = params?.BUNDLE_ID?.trim()                               // e.g. "com.feedhenry.welcome-ios"
